...
LIB_OBJS := bin/common.o bin/model_reader.o bin/sypha_environment.o bin/sypha_logger.o bin/sypha_node_sparse.o bin/sypha_preprocessor.o bin/sypha_solver.o bin/sypha_solver_dense_linear.o bin/sypha_solver_workspace.o bin/sypha_solver_init.o bin/sypha_solver_balas.o bin/sypha_solver_bnb.o bin/sypha_solver_bnb_driver.o bin/sypha_solver_heuristics.o bin/sypha_solver_cuts.o bin/sypha_solver_utils.o bin/sypha_solver_krylov.o bin/sypha_api.o

sypha : common main model_reader sypha_environment sypha_logger sypha_node_sparse sypha_preprocessor sypha_solver sypha_solver_dense_linear sypha_solver_workspace sypha_solver_init sypha_solver_balas sypha_solver_bnb sypha_solver_bnb_driver sypha_solver_heuristics sypha_solver_cuts sypha_solver_utils sypha_solver_krylov sypha_api
...
sypha_logger : src/sypha_logger.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin
...
sypha_preprocessor : src/sypha_preprocessor.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver : src/sypha_solver.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_dense_linear : src/sypha_solver_dense_linear.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_workspace : src/sypha_solver_workspace.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_init : src/sypha_solver_init.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_balas : src/sypha_solver_balas.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_bnb : src/sypha_solver_bnb.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_bnb_driver : src/sypha_solver_bnb_driver.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_heuristics : src/sypha_solver_heuristics.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin

sypha_solver_cuts : src/sypha_solver_cuts.cpp
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -c src/$@.cpp $(LIBRARIES)
	@mv $@.o bin
...
scp_solver : common model_reader sypha_environment sypha_logger sypha_node_sparse sypha_preprocessor sypha_solver sypha_solver_dense_linear sypha_solver_workspace sypha_solver_init sypha_solver_balas sypha_solver_bnb sypha_solver_bnb_driver sypha_solver_heuristics sypha_solver_cuts sypha_solver_utils sypha_solver_krylov sypha_api
