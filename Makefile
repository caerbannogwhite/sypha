...
LIB_OBJS := bin/common.o bin/model_reader.o bin/sypha_environment.o bin/sypha_logger.o bin/sypha_node_sparse.o bin/sypha_preprocessor.o bin/sypha_solver.o bin/sypha_solver_dense_linear.o bin/sypha_solver_workspace.o bin/sypha_solver_init.o bin/sypha_solver_bnb.o bin/sypha_solver_bnb_driver.o bin/sypha_solver_heuristics.o bin/sypha_solver_cuts.o bin/sypha_solver_utils.o bin/sypha_solver_krylov.o bin/sypha_api.o

sypha : common main model_reader sypha_environment sypha_logger sypha_node_sparse sypha_preprocessor sypha_solver sypha_solver_dense_linear sypha_solver_workspace sypha_solver_init sypha_solver_bnb sypha_solver_bnb_driver sypha_solver_heuristics sypha_solver_cuts sypha_solver_utils sypha_solver_krylov sypha_api
